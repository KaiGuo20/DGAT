...
class GOODPubmed(InMemoryDataset):
    r"""
    ...
    def process(self):
        ...
        # graph = dataset[0]
        dataset = torch.load('data/pubmed.pt')
        graph = dataset
    ...
    def load(dataset_root: str, domain: str, shift: str = 'no_shift', generate: bool = False):
        ...
        if domain == "degree" and shift == "covariate":
            dataset = torch.load(
                f"/mnt/home/guokai1/workspace/GOOD/GOOD/data/good_datasets/{'pubmed'}_{'degree'}_{'covariate'}.pt",
                map_location='cpu')
        if domain == "word" and shift == "covariate":
            dataset = torch.load(
                f"/mnt/home/guokai1/workspace/GOOD/GOOD/data/good_datasets/{'pubmed'}_{'word'}_{'covariate'}.pt",
                map_location='cpu')
        if domain == "degree" and shift == "concept":
            dataset = torch.load(
                f"/mnt/home/guokai1/workspace/GOOD/GOOD/data/good_datasets/{'pubmed'}_{'degree'}_{'concept'}.pt",
                map_location='cpu')
        if domain == "word" and shift == "concept":
            dataset = torch.load(
                f"/mnt/home/guokai1/workspace/GOOD/GOOD/data/good_datasets/{'pubmed'}_{'word'}_{'concept'}.pt",
                map_location='cpu')
        ...
        dataset.processed_dir = "/mnt/ufs18/home-246/guokai1/workspace/GOOD/storage/datasets/GOODPubmed/degree/processed"
